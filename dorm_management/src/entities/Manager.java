...
/**
 * A manager with a unique name and a list of students.
 */
public class Manager extends BasicManager {
    ...
    /**
     * Remove the student with the specified social insurance number
     * from the list of those being treated by this manager
     *
     * @param sNSID the social insurance number of a Student
