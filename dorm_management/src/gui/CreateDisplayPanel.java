        ...
        removeButton.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (release.wasSuccessful())
                    ...
                    JOptionPane.showMessageDialog(CreateDisplayPanel.this, release.getErrorMessage());
            }
        });
    }
        ...
        textField.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent event) {
                ...
                if (assignBedCmd.wasSuccessful())
                    ...
                    JOptionPane.showMessageDialog(CreateDisplayPanel.this, assignBedCmd.getErrorMessage());
                }
            }
        });
    }
